<x-app-layout>
    <x-slot name="header">
        ...
        <div class="py-10 px-6 md:max-w  bg-white shadow rounded ">
            <h2 class="text-2xl font-semibold mb-6">Statistik Todo</h2>
        
            <div class="flex flex-1 md:grid-cols-3 gap-6 text-center">
                <div class="bg-blue-100 p-4 rounded">
                    <p class="text-gray-600">Total Todo</p>
            ...
            <h3 class="text-xl font-semibold mt-10 mb-4">Todo Terbaru</h3>
            <ul class="space-y-2">
                ...
                <li class="border p-3 rounded flex justify-between items-center">
                    ...
                    <span class="text-sm font-medium {{ $todo->is_done ? 'text-green-600' : 'text-red-600' }}">
                        {{ $todo->is_done ? 'Selesai' : 'Belum' }}
                    </span>
                </li>
                @empty
                <li class="text-gray-500">Belum ada todo.</li>
                @endforelse
            </ul>
        </div>
    </x-slot>
